<?php
    /**
     * @package POWr Photo Editor
     * @version 1.4
     */
    /*
    Plugin Name: POWr Photo Editor
    Plugin URI: http://www.powr.io
    Description: Edit, filter, and resize any image!  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.4
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////Create Photo Editor widget/////////////////////////////////
    class Powr_Photo_Editor extends WP_Widget{
      //Create the widget
      public function __construct(){
        parent::__construct( 'powr_photo_editor',
                             __( 'POWr Photo Editor' ),
                             array( 'description' => __( 'Photo Editor by POWr.io') )
        );
      }
      //This prints the div
      public function widget( $args, $instance ){
        ...
        ?>
        <div class='widget powr-photo-editor' label='<?php echo $label; ?>'></div>
        <?php
      }
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Photo Editor.
        </p>
        <p>
    ...
    function register_powr_photo_editor() {
      register_widget( 'Powr_Photo_Editor' );
    }
    //Use widgets_init action hook to execute custom function
    add_action( 'widgets_init', 'register_powr_photo_editor' );
    //Create short codes for adding plugins anywhere:
    function powr_photo_editor_shortcode( $atts ){
      if(isset($atts['label'])){
        $label = $atts['label'];
      }else{
        $label = '';
      }
      return "<div class='powr-photo-editor' label='$label'></div>";
    }
    add_shortcode( 'powr-photo-editor', 'powr_photo_editor_shortcode' );
